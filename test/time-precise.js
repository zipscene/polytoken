...
const { coreDimensions: { TimePreciseDimension } } = require('../lib');

describe('TimeDimension', function() {
	before(function() {
		this.time = new TimePreciseDimension({
			step: {
				type: 'customized',
	...
	describe('#constructor', function() {
		it('should set name and tokenConfig', function() {
			expect(this.time).to.be.instanceof(TimePreciseDimension);
			expect(this.time).to.have.property('name', 'TimePrecise');
	...
	describe('#getName', function() {
		it('should get name of time dimension', function() {
			...
			expect(name).to.equal('TimePrecise');
		});
	});
